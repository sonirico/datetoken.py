...
class DateTokenToUTCDateTestCase(unittest.TestCase, DatetokenComparatorMixin):
    ...
    def test_token_snapped_to_beginning_of_hour(self):
        payload = "now/h"
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(actual, datetime(2016, 11, 28, 12, 0, 0, tzinfo=pytz.UTC))

    def test_token_snapped_to_beginning_of_day(self):
        payload = "now/d"
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(actual, datetime(2016, 11, 27, 23, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 2, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_week(self):
        payload = "now/w"
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(actual, datetime(2019, 2, 17, 23, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 2, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_month(self):
        payload = "now/M"
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(actual, datetime(2019, 1, 31, 23, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 2, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_year(self):
        payload = "now/Y"
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(actual, datetime(2018, 12, 31, 23, 0, 0, tzinfo=pytz.UTC))
    ...
    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_current_quarter(self):
        payload = "now/Q"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(actual, datetime(2019, 4, 1, 0, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_q1(self):
        payload = "now/Q1"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(actual, datetime(2019, 1, 1, 0, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_q2(self):
        payload = "now/Q2"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(actual, datetime(2019, 4, 1, 0, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_q3(self):
        payload = "now/Q3"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(actual, datetime(2019, 7, 1, 0, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_q4(self):
        payload = "now/Q4"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(actual, datetime(2019, 10, 1, 0, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_ending_of_current_quarter(self):
        payload = "now@Q"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(
            actual, datetime(2019, 6, 30, 23, 59, 59, tzinfo=pytz.UTC)
        )

    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_ending_of_q1(self):
        payload = "now@Q1"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(
            actual, datetime(2019, 3, 31, 23, 59, 59, tzinfo=pytz.UTC)
        )

    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_ending_of_q2(self):
        payload = "now@Q2"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(
            actual, datetime(2019, 6, 30, 23, 59, 59, tzinfo=pytz.UTC)
    ...
    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_ending_of_q3(self):
        payload = "now@Q3"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(
            actual, datetime(2019, 9, 30, 23, 59, 59, tzinfo=pytz.UTC)
        )

    @freeze_time(datetime(2019, 6, 20, 15, 45, 12))
    def test_token_snapped_to_ending_of_q4(self):
        payload = "now@Q4"
        actual = token_to_utc_date(payload, tz="UTC")
        self.compare_datetime(
            actual, datetime(2019, 12, 31, 23, 59, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_ending_of_minute(self):
        ...
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(
            actual, datetime(2016, 11, 28, 12, 55, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_ending_of_day(self):
        ...
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(
            actual, datetime(2016, 11, 28, 22, 59, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_ending_of_business_week(self):
        ...
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(
            actual, datetime(2019, 2, 22, 22, 59, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_ending_of_month(self):
        ...
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(
            actual, datetime(2016, 11, 30, 22, 59, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_ending_of_year(self):
        ...
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(
            actual, datetime(2016, 12, 31, 22, 59, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_ending_of_year_edge_case_2(self):
        ...
        actual = token_to_utc_date(payload, tz="Europe/Madrid")
        self.compare_datetime(
            actual, datetime(2019, 12, 31, 22, 59, 59, tzinfo=pytz.UTC)
        )

    def test_invalid_string_should_raise(self):
        self.assertRaises(InvalidTokenException, token_to_utc_date, "then-1d/d")
        self.assertRaises(InvalidTokenException, token_to_utc_date, "now-1Z/d")
...
class DateTokenParseToDateTestCase(unittest.TestCase, DatetokenComparatorMixin):
    ...
    def test_token_snapped_to_beginning_of_day(self):
        payload = "now/d"
        actual = token_to_date(payload)
        self.compare_datetime(actual, datetime(2016, 11, 28, 0, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 2, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_week(self):
        payload = "now/w"
        actual = token_to_date(payload)
        self.compare_datetime(actual, datetime(2019, 2, 18, 0, 0, 0, tzinfo=pytz.UTC))

    @freeze_time(datetime(2019, 2, 20, 15, 45, 12))
    def test_token_snapped_to_beginning_of_month(self):
        payload = "now/M"
        actual = token_to_date(payload)
        self.compare_datetime(actual, datetime(2019, 2, 1, 0, 0, 0, tzinfo=pytz.UTC))
    ...
    def test_token_snapped_to_ending_of_day(self):
        ...
        actual = token_to_date(payload)
        self.compare_datetime(
            actual, datetime(2016, 11, 28, 23, 59, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_ending_of_week(self):
        ...
        actual = token_to_date(payload)
        self.compare_datetime(
            actual, datetime(2019, 2, 24, 23, 59, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_previous_friday(self):
        ...
        actual = token_to_date(payload)
        self.compare_datetime(
            actual, datetime(2016, 11, 25, 12, 55, 23, tzinfo=pytz.UTC)
        )
    ...
    def test_token_snapped_to_following_friday(self):
        ...
        actual = token_to_date(payload)
        self.compare_datetime(
            actual, datetime(2016, 12, 2, 12, 55, 23, tzinfo=pytz.UTC)
        )
    ...
    def test_day_of_week_token_can_be_combined_1(self):
        payload = "now@sun/d"
        actual = token_to_date(payload)
        self.compare_datetime(actual, datetime(2016, 12, 4, 0, 0, 0, tzinfo=pytz.UTC))
    ...
    def test_token_snapped_to_ending_of_year(self):
        ...
        actual = token_to_date(payload)
        self.compare_datetime(
            actual, datetime(2016, 12, 31, 23, 59, 59, tzinfo=pytz.UTC)
        )
    ...
    def test_invalid_string_should_raise(self):
        self.assertRaises(InvalidTokenException, token_to_date, "then-1d/d")
        self.assertRaises(InvalidTokenException, token_to_date, "now-1Z/d")
